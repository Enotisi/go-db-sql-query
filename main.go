...
func main() {
	...
	newClient := Client{
		...
		Login:    "oldTest",              // укажите логин
		Birthday: "19900415",             // укажите день рождения
		Email:    "newtest@mail.ru",      // укажите почту
	}
	...
	newLogin := "newtest" // укажите новый логин
...
func insertClient(db *sql.DB, client Client) (int64, error) {
	...
	return lastIndex, nil // вместо 0 верните идентификатор добавленной записи
}
